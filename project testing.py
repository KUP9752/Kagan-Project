...
CharUp = [spritesheet.parse_sprite('charup1.png'),
          spritesheet.parse_sprite('charup1.png'),
          spritesheet.parse_sprite('charup1.png'),
          spritesheet.parse_sprite('charup2.png'),
          spritesheet.parse_sprite('charup2.png'),
          spritesheet.parse_sprite('charup2.png'),
          spritesheet.parse_sprite('charup3.png'),
          spritesheet.parse_sprite('charup3.png'),
          spritesheet.parse_sprite('charup3.png'),
          spritesheet.parse_sprite('charup4.png'),
          spritesheet.parse_sprite('charup4.png'),
          spritesheet.parse_sprite('charup4.png')]

CharDown = [spritesheet.parse_sprite('chardown1.png'),
            spritesheet.parse_sprite('chardown2.png'),
            spritesheet.parse_sprite('chardown3.png'),
            spritesheet.parse_sprite('chardown4.png')]
CharRight = [spritesheet.parse_sprite('charright1.png'),
             spritesheet.parse_sprite('charright2.png'),
             spritesheet.parse_sprite('charright3.png'),
             spritesheet.parse_sprite('charright4.png')]
CharLeft = [spritesheet.parse_sprite('charleft1.png'),
            spritesheet.parse_sprite('charleft2.png'),
            spritesheet.parse_sprite('charleft3.png'),
            spritesheet.parse_sprite('charleft4.png')]

CharUpRight = [spritesheet.parse_sprite('charupright1.png'),
               spritesheet.parse_sprite('charupright2.png'),
               spritesheet.parse_sprite('charupright3.png'),
               spritesheet.parse_sprite('charupright4.png')]
CharUpLeft=[spritesheet.parse_sprite('charupleft1.png'),
            spritesheet.parse_sprite('charupleft2.png'),
            spritesheet.parse_sprite('charupleft3.png'),
            spritesheet.parse_sprite('charupleft4.png')]
CharDownRight=[spritesheet.parse_sprite('chardownright1.png'),
               spritesheet.parse_sprite('chardownright2.png'),
               spritesheet.parse_sprite('chardownright3.png'),
               spritesheet.parse_sprite('chardownright4.png')]
CharDownLeft=[spritesheet.parse_sprite('charupleft1.png'),
              spritesheet.parse_sprite('charupleft2.png'),
              spritesheet.parse_sprite('charupleft3.png'),
              spritesheet.parse_sprite('charupleft4.png')]


Enemy3Up =[spritesheet.parse_sprite('enemy3up1.png'),
           spritesheet.parse_sprite('enemy3up2.png'),
           spritesheet.parse_sprite('enemy3up3.png'),
           spritesheet.parse_sprite('enemy3up4.png')]
Enemy3Down =[spritesheet.parse_sprite('enemy3down1.png'),
             spritesheet.parse_sprite('enemy3down2.png'),
             spritesheet.parse_sprite('enemy3down3.png'),
             spritesheet.parse_sprite('enemy3down4.png')]
Enemy3Right =[spritesheet.parse_sprite('enemy3right1.png'),
              spritesheet.parse_sprite('enemy3right2.png'),
              spritesheet.parse_sprite('enemy3right3.png'),
              spritesheet.parse_sprite('enemy3right4.png')]
Enemy3Left =[spritesheet.parse_sprite('enemy3left1.png'),
             spritesheet.parse_sprite('enemy3left2.png'),
             spritesheet.parse_sprite('enemy3left3.png'),
             spritesheet.parse_sprite('enemy3left4.png')]
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if (self.rect.x>=0 and self.rect.x<=(1000-self.width)) and (self.rect.y >=0 and self.rect.y<=(720-self.height)):
